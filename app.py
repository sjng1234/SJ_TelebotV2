...
TOKEN = '1957192471:AAH9usVw8M9j5-Wsm5Bh5PgWv_5dCkEisk4'
...
def getStock(update,context):
    ...
    if data.size > 0:
        ...
        update.message.reply_text(f'Close Price of {ticker} for past 5 minutes:'+'\n'+data['Close'].to_string(header=False))
    else:
...
def main():
    ...
    updater.start_webhook(listen="0.0.0.0",
                          port=int(PORT),
                          url_path=TOKEN)
    updater.bot.setWebhook('https://cryptic-stream-96120.herokuapp.com/' + TOKEN)
